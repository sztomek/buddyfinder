...
data class DeclineConnectionRequest(val requestId: String, override var notificationId: Int) : NotificationAction, KParcelable {
    ...
    companion object {
        @JvmField
        val CREATOR = parcelableCreator(::DeclineConnectionRequest)
    }
