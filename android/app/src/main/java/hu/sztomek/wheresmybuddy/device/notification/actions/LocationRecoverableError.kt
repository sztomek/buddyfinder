...
data class LocationRecoverableError(override var notificationId: Int) : NotificationAction, KParcelable {
    ...
    companion object {
        @JvmField
        val CREATOR = parcelableCreator(::LocationRecoverableError)
    }
