...
data class DeclineNotTrustedLocationRequest(val fromUserId: String, override var notificationId: Int) : NotificationAction, KParcelable {
    ...
    companion object {
        @JvmField
        val CREATOR = parcelableCreator(::DeclineNotTrustedLocationRequest)
    }
