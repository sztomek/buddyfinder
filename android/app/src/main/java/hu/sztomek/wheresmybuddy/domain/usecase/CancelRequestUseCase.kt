...
class CancelRequestUseCase @Inject constructor(private val appSchedulers: AppSchedulers, private val datasource: IDatasource) {

    fun execute(action: Action.CancelRequestAction): Single<Result> {
        return datasource.cancelConnectionRequest(action.requestId)
