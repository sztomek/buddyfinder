...
data class TrustedLocationRequest(val fromUserId: String, override var notificationId: Int) : NotificationAction, KParcelable {
    ...
    companion object {
        @JvmField
        val CREATOR = parcelableCreator(::TrustedLocationRequest)
    }
